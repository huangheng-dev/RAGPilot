const zhCN = {
  ...
  operations: {
    ...
    runtimeTaskPacket: {
      ...
      failedDetail: "这条失败执行应带着工作流和源对象上下文一起推进，再决定是否继续重试。",
    ...
    executionPackets: {
      ...
      recovery: {
        title: "恢复执行包",
        metric: "范围内失败运行",
        failedDetail: "当前租户范围内还有 {count} 条失败工作流运行需要主动恢复处理。",
        healthyDetail: "当前租户暂时没有可见的失败工作流压力。",
        primaryAction: "打开失败分区",
  ...
  settings: {
    ...
    fields: {
      ...
      email: "邮箱",
      role: "角色",
      roleManaged: "如需切换本地模拟角色，请通过登录流程重新进入。",
      directoryLinked: "已绑定持久化成员目录",
      directoryUnlinked: "仅本地会话",
      memberships: "租户成员关系",
  ...
  home: {
    ...
    core: {
      ...
      workflowsDetail: "当前范围共有 {total} 条运行，{active} 条活跃，{failed} 条失败。",
      noActivity: "暂无活动"
    },
    capabilities: {
      title: "核心平台能力",
  ...
  admin: {
    ...
    securitySummary: {
      ...
      expiringInvitationsHint: "已经过期或将在 72 小时内过期的邀请数量。",
      sensitiveEvents: "敏感事件",
      sensitiveEventsHint: "当前范围内最近的撤销、暂停和成员移除事件数量。"
    },
    securityWatch: {
      title: "安全复核队列",
    ...
    members: {
      ...
      displayName: "显示名称",
      displayNamePlaceholder: "RagPilot 运营员",
      email: "邮箱",
    ...
    watchlist: {
      ...
      workflowRecoveryPressureDetail: "当前还有 {count} 条失败工作流分布在 {tenantCount} 个租户中，需要继续推进恢复治理。",
  ...
  auth: {
    ...
    badge: "本地访问",
    heading: "登录 RagPilot",
    description: "通过持久化成员目录进入运营控制台。当前角色和租户访问范围会直接从目录解析，不再由登录页手动选择。",
    hero: {
      eyebrow: "运营访问",
      title: "受控进入知识运营平台",
    ...
    guard: {
      ...
      redirectingDescription: "当前页面受保护，需要先完成本地登录。",
      redirectingStatus: "正在跳转到本地登录...",
  ...
  workspace: {
    ...
    runtimeRunbook: {
      ...
      mainFlow: {
        ...
        monitorFailureDetail: "当前存在失败队列，需要先复核工作流压力和恢复状态，再回到验证环节。",
    ...
    chatView: {
      ...
      feedbackHelpfulMetric: "有帮助",
      feedbackReviewMetric: "待复核",
      feedbackCitationMetric: "引用问题",
      feedbackTotalMetric: "反馈总数",
      ...
      feedbackUseValidationQuery: "用作验证问题",
      feedbackRunComparison: "运行对比检查",
