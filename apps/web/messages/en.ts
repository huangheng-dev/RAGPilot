const en = {
  ...
  agents: {
    ...
    status: {
      ...
      migrated: "Upgraded {count} standard agent drafts to the current product copy.",
      seeded: "Initialized {count} standard agent drafts.",
      restoreFailed: "Agent definition loading failed.",
      noTenants: "No tenants are provisioned yet. Create a tenant before defining agents.",
      ...
      activationBlocked: "Active agents must have a valid model, an allowed scope, and at least one connected tool before they can be saved.",
      runtimeLaunchBlocked: "Only active, runtime-ready agents can be launched into delivery surfaces.",
    ...
    executionPackets: {
      ...
      description: "Bundle definition readiness, runtime routing, governance posture, and surface delivery into one formal control layer.",
      statuses: {
        attention: "Attention",
        review: "Review",
        healthy: "Healthy"
      ...
      readiness: {
        ...
        reviewDetail: "{name} still has {count} readiness issues to resolve before clean runtime delivery.",
        emptyDetail: "Select an agent to inspect runtime readiness and governance posture.",
      ...
      delivery: {
        ...
        emptyDetail: "No runtime destination is available yet. Scope and mode need to be aligned first.",
      ...
      runtime: {
        ...
        detail: "{count} connected capabilities are available. Runtime model: {model}.",
        emptyDetail: "Select an agent to inspect runtime capabilities and the resolved model path.",
      ...
      retrieval: {
        ...
        readyDetail: "{profile} is currently aligned to the selected knowledge scope.",
        missingDetail: "The selected scope ({scope}) still needs a governed retrieval posture before clean runtime delivery.",
        disabledDetail: "{profile} is currently disabled and should be remediated before runtime delivery continues.",
        emptyDetail: "Select a grounded or document-intake definition to inspect retrieval governance posture.",
      ...
      governance: {
        ...
        activeDetail: "{active} active definitions are currently visible out of {total} total definitions in this tenant scope.",
        emptyDetail: "No active agent definitions are currently visible in this tenant scope.",
    ...
    releaseBoard: {
      title: "Release board",
      description: "Review whether the selected definition is complete enough to move from design into a governed runtime lane.",
      definition: {
        title: "Definition baseline",
        metric: "Completed definition fields",
        readyDetail: "Name, slug, objective, and operating instructions are all present for this definition.",
        reviewDetail: "{count} required definition fields still need to be completed before clean rollout.",
        emptyDetail: "Select an agent definition to inspect its release completeness.",
      ...
      scope: {
        ...
        reviewDetail: "This runtime lane still needs an explicit workspace and knowledge scope before release.",
        optionalDetail: "This runtime lane can launch without a knowledge scope, but should still stay inside tenant governance.",
      ...
      retrieval: {
        ...
        readyDetail: "{profile} is already available for governed retrieval in this lane.",
        missingDetail: "This lane still needs a valid governed retrieval profile before release.",
        disabledDetail: "{profile} is disabled and should be remediated before release.",
        notRequiredDetail: "This lane does not require a retrieval profile to move forward.",
        emptyDetail: "Select a definition to inspect retrieval-governance posture.",
      ...
      runtime: {
        ...
        readyDetail: "{model} is available through {provider}, and connected capabilities are already present.",
        reviewDetail: "{model} is resolved, but the runtime still needs connected capabilities before delivery.",
        emptyRuntimeDetail: "No runtime model is currently resolved for this definition.",
      ...
      governance: {
        ...
        healthyDetail: "Governance posture is stable. Current definition status: {status}.",
        reviewDetail: "{count} bound tool registrations are disabled and need governance cleanup.",
        pendingDetail: "{count} registered tools still sit behind an approval boundary.",
        emptyDetail: "Select an agent definition to inspect governance handoff.",
    ...
    architecture: {
      ...
      groundedChat: {
        ...
        description: "{total} grounded-chat drafts are currently staged for citation-backed answers and thread delivery.",
        value: "{active} active of {total}"
      },
      documentIntake: {
        title: "Document intake lane",
        description: "{total} document-intake drafts are aligned to ingestion follow-up and document supervision.",
        value: "{active} active of {total}"
      },
      workflowRecovery: {
        title: "Workflow recovery lane",
        description: "{total} workflow-recovery drafts are positioned for failed-run triage and controlled retry handling.",
        value: "{active} active of {total}"
      },
      governance: {
        title: "Governance review lane",
        description: "{ready} drafts already satisfy the minimum scope, tool, and activation posture for runtime rollout.",
    ...
    governance: {
      ...
      description: "Turn scope, model, and tool failures into direct list filters so runtime cleanup can move through a narrower operator queue.",
    ...
    editor: {
      ...
      toolHint: "Only the explicitly approved surfaces below should be available to this agent.",
      registeredTools: "Registered tools",
      registeredToolsHint: "Bind persisted tool registrations that the future runtime can invoke for this agent.",
      noRegisteredTools: "No enabled tool registrations are available yet. Add them in Settings first.",
      namePlaceholder: "Agent name",
      slugPlaceholder: "agent-slug",
      scopePlaceholder: "Select a knowledge base",
      unscoped: "Unscoped",
      objectivePlaceholder: "Describe the business outcome this agent is expected to deliver.",
      instructionsPlaceholder: "Define the operating policy, escalation rules, and output behavior for this agent."
    },
    modes: {
    ...
    connectivity: {
      ...
      chatDescription: "Grounded chat for citation review, thread history, and scoped Q&A.",
      documentsDescription: "Document registry for ingestion state, document detail, and reindex actions.",
      operationsDescription: "Workflow supervision for queues, retries, and failure recovery.",
      adminDescription: "Governance surface for scope review, publication control, and lifecycle actions."
    },
    delivery: {
      title: "Runtime handoff",
      description: "Route the selected agent into the most relevant built surface while keeping tenant and scope context intact.",
      selectedAgentTitle: "Selected definition",
      selectedAgentDescription: "{mode} is currently in {status} and ready for routed handoff review.",
      ...
      chatReady: "This grounded-chat agent is already scoped to {scope} and can enter the live chat surface directly.",
      documentsReady: "This document-intake agent is already scoped to {scope} and can open the document operations surface directly.",
      operationsReady: "This workflow-recovery agent should enter the failed-run operations queue first.",
      scopeRequired: "Assign a workspace and knowledge base scope so the handoff can stay grounded in live resources.",
      ...
      launchPromptsDescription: "Use these mode-aware prompts to enter the chat surface with a ready-to-run operator brief.",
      ...
      primaryChatDescription: "Start in grounded chat with the current scope and a suggested operator prompt already loaded.",
      primaryDocumentsDescription: "Open the document registry first so intake work, failed files, and reindex actions stay in one lane.",
      primaryOperationsDescription: "Enter workflow operations first to inspect failed runs, retry lineage, and queue pressure before returning elsewhere.",
      secondaryChatDescription: "Use chat for a concise operator brief after the current runtime lane is stable.",
      secondaryDocumentsDescription: "Open documents to inspect the current knowledge-base state and source readiness before retrieval begins.",
      tertiaryDocumentsDescription: "Use the document registry as a follow-up lane when workflow recovery depends on source-level cleanup.",
      tertiaryOperationsDescription: "Open workflow operations when runtime health needs queue supervision or retry follow-up.",
      checkScopeReady: "Scope ready: {scope}",
      checkScopeMissing: "Scope missing: assign a workspace and knowledge base before runtime launch.",
      checkModelReady: "Runtime model ready: {name}",
      checkModelInherited: "Runtime model inherits from the current strategy.",
      checkToolsReady: "{count} connected capabilities available for execution.",
      checkToolsMissing: "No connected capabilities are available yet. Bind tools before autonomous execution.",
      runtimeTaskPending: "Pending",
      runtimeTaskNoObjective: "No formal business objective has been attached to this agent yet.",
      runtimeTaskNoPrompt: "No launch prompt is available yet for this handoff.",
      runtimeTaskScopeNotRequired: "Scope is not required for the recovery lane.",
    ...
    dependencies: {
      ...
      retrievalProfileDescription: "{source} profile with {mode} mode and Top K {topK}.",
      ...
      noRegisteredTools: "No persisted registered tools are currently bound to this definition.",
    ...
    runs: {
      title: "Run history",
      description: "Persisted launch history for the current tenant or selected definition, so runtime handoffs become traceable instead of transient.",
    ...
    runbook: {
      ...
      description: "Use a mode-aware operating sequence so launch, escalation, and governance closure stay on the built platform path.",
      empty: "Select an agent definition to generate a mode-aware operator runbook.",
      ...
      groundedChat: {
        ...
        scopeReady: "The grounded-chat lane already resolves to {scope}. Review the scoped documents before answering live questions.",
        scopeMissing: "This grounded-chat lane still needs an explicit workspace and knowledge scope before live delivery.",
        launchTitle: "Launch the answer lane",
        launchDetail: "Enter the chat surface with the current launch prompt so the operator starts from a formal, citation-aware brief.",
        closureTitle: "Close the governance loop",
        closureDetail: "{count} approval-gated registered tools still need to be reviewed before broader rollout."
      },
      documentIntake: {
        intakeTitle: "Inspect the intake lane",
        intakeDetail: "Start in the document surface so ingestion state, reindex needs, and source quality signals stay visible.",
        recoveryTitle: "Escalate exceptions into operations",
        recoveryDetail: "Move failed or risky intake cases into workflow operations once source-level inspection is complete.",
        briefingTitle: "Prepare the operator brief",
        briefingDetail: "Open chat with a mode-aware prompt to summarize the intake state and the next execution priorities."
      },
      workflowRecovery: {
        triageTitle: "Triage failed runs",
        triageDetail: "Start in workflow operations and rank failed runs before deciding which retry chains deserve intervention first.",
        cleanupTitle: "Confirm source cleanup",
        cleanupDetail: "Review failed or risky source material in the document surface before sending recovery back into runtime.",
        approvalTitle: "Confirm governance approval",
        approvalDetail: "{count} approval-gated registered tools remain in the governance path for this recovery lane."
      }
    },
    guardrails: {
      title: "Execution guardrails",
      description: "Runtime activation should only proceed after scope, policy, and governance controls are explicitly defined.",
      retrievalTitle: "Retrieval boundary",
      retrievalReady: "This draft already names a retrieval scope: {scope}, using {profile}.",
      retrievalMissing: "Define a knowledge scope before enabling autonomous retrieval behavior.",
      ...
      governanceMissing: "Define status and model strategy before formal rollout."
    },
    readiness: {
      ready: "Ready",
      ...
      issues: {
        ...
        tool_registration_disabled: "{count} bound tool registrations are disabled",
        tool_approval_required: "{count} bound tool registrations still require governance approval",
        tool_mcp_reserved: "{count} bound reserved MCP tools still need a governed connector assignment",
        tool_mcp_integration_pending: "{count} bound reserved MCP tools are waiting for connector runtime closure"
      }
    },
    seed: {
      knowledgeCopilotName: "Knowledge Assistant",
      knowledgeCopilotObjective: "Support grounded knowledge questions and maintain citation quality for the default handbook scope.",
      ...
      documentReviewerObjective: "Review newly indexed content, flag weak metadata, and coordinate reindex follow-up through document operations.",
      ...
      workflowResponderObjective: "Track failed document-ingestion runs and prepare operator-ready recovery steps before retrying execution.",
  ...
  operations: {
    ...
    status: {
      ...
      noTenants: "No tenants are provisioned yet. Create a tenant before supervising operations.",
    ...
    metrics: {
      total: "Total runs",
      totalHint: "All workflow runs currently recorded for the selected tenant.",
      active: "Active runs",
      activeHint: "Queued and running execution that still needs operator awareness.",
      failed: "Failed runs",
      failedHint: "Runs that currently require investigation or a controlled retry path.",
      activeAgents: "Active agents",
      agentsHint: "Enabled agent definitions available to support operational recovery."
    },
    lanes: {
      title: "Execution lanes",
      description: "Use stable execution lanes to move between overall supervision, failed recovery, retry volume, and queue pressure.",
      overview: "Overview",
      overviewDescription: "All tenant workflow volume in one supervisory lane.",
      failed: "Failed runs",
      failedDescription: "Directly focus the failed-run queue that needs human recovery.",
      retries: "Retry queue",
      retriesDescription: "Inspect runs that were already re-issued from earlier failures.",
      pressure: "Queue pressure",
      pressureDescription: "Watch the active queue where accepted work is waiting to execute."
    },
    scope: {
    ...
    directory: {
      ...
      description: "Recent workflow execution across the selected tenant, tuned for triage and follow-up.",
    ...
    focus: {
      ...
      description: "Keep the selected run, retry posture, and platform handoff decisions in one place.",
      selectedRun: "Selected run",
      notSelected: "No run selected",
      selectHint: "Choose a workflow run to inspect runtime detail and retry posture.",
      ...
      nextStep: "Next step",
      nextStepFailed: "This failed run should stay in the recovery lane until the blocking cause is understood and the source scope is checked.",
      nextStepCompleted: "This run completed successfully. Continue in workspace chat or document review to validate downstream retrieval readiness.",
      nextStepActive: "This run is still active. Keep it inside workflow supervision until queue pressure and step progress are clear.",
      nextStepEmpty: "Select a workflow run to unlock the next-step handoff actions.",
    ...
    detail: {
      ...
      empty: "Select a workflow run to inspect step detail, runtime timing, and workspace follow-up links.",
    ...
    recoveryAgents: {
      ...
      description: "Active workflow-recovery agents available for this tenant's failed-run supervision path.",
      activeCount: "Active recovery agents",
      activeReady: "These agents can be reviewed or launched before operators re-enter the failed queue.",
      activeEmpty: "No active workflow-recovery agents are currently available in this tenant scope.",
      runtimePacket: "Runtime packet",
      noObjective: "No explicit recovery objective is attached to this agent yet.",
    ...
    runtimeTaskPacket: {
      ...
      description: "Promote the current recovery handoff into one governed task packet before leaving the operations surface.",
      emptyTitle: "No active runtime task",
      emptyDetail: "Select a workflow run or recovery agent to build the next runtime task packet.",
      monitoringDetail: "Queued, running, or retry traffic is still active in this scope. Keep operations supervision in focus before leaving the lane.",
    ...
    agentRuntime: {
      ...
      description: "Keep recorded agent launches that entered the operations surface visible alongside recovery, queue, and governance follow-up.",
      openAgents: "Open agents",
      ...
      noSourceMix: "No operations launches are available yet for source analysis.",
      recentRuns: "Recent operations launches",
      empty: "No recorded agent launches have entered the operations surface in the current scope yet.",
      unknownAgent: "Unknown agent definition"
    },
    agentExecutions: {
    ...
    executionPackets: {
      title: "Execution packets",
      description: "Move the current tenant straight into recovery, retry supervision, runtime handoff, or workspace follow-up without rebuilding context.",
      statuses: {
        attention: "Attention",
        review: "Review",
        healthy: "Healthy"
      ...
      retry: {
        ...
        readyDetail: "{count} retry runs are already active and should be supervised as a separate recovery queue.",
        emptyDetail: "No retry runs are currently visible in this tenant scope.",
      ...
      agent: {
        ...
        readyDetail: "{scopedCount} of {totalCount} active recovery agents already have scoped runtime boundaries.",
        emptyDetail: "No active recovery agents are currently available for this tenant scope.",
      ...
      governance: {
        ...
        readyDetail: "{name} is already aligned with a scoped recovery route and can stay linked to governance follow-up.",
        pendingDetail: "{count} active recovery agents are visible, but governance still needs to close the scope and access posture cleanly.",
        emptyDetail: "No active recovery agents are currently available to hand into governance follow-up.",
      ...
      followUp: {
        ...
        completedDetail: "The selected run completed. Continue in workspace surfaces to confirm downstream retrieval readiness.",
        failedDetail: "The selected run failed. Follow the workflow and subject surfaces together before attempting another retry.",
        activeDetail: "The selected run is still active. Keep supervision and workspace follow-up aligned until execution settles.",
        emptyDetail: "Select a workflow run before handing the current execution back into workspace surfaces.",
        notSelected: "No run selected",
  ...
  settings: {
    ...
    sections: {
      ...
      accessDescription: "Recent sign-in and membership governance events scoped to the current signed-in member.",
      platformTitle: "Platform links",
      platformDescription: "Fast paths into the built control surfaces, local API, and repository."
    },
    fields: {
      name: "Display name",
      email: "Email",
      ...
      membershipAccessReadyDescription: "At least one active tenant membership is available for this session.",
      membershipAccessBlockedDescription: "This session is tied only to invited or suspended tenant memberships and should not stay signed in.",
      membershipAccessBootstrapDescription: "No tenant memberships are linked yet, so this session remains in bootstrap mode.",
      pendingRole: "Pending session role",
      adminAccess: "Admin access",
      adminAllowed: "Available",
      adminDenied: "Not available",
      language: "Language mode",
      languageValue: "English remains the default product language while Simplified Chinese stays available for operators.",
      theme: "Appearance",
      themeLight: "Light mode",
      themeDark: "Dark mode",
      themeValue: "The selected appearance is applied across the current browser session.",
      apiBaseUrl: "API base URL",
      retrievalEngine: "Retrieval engine",
      retrievalEngineHint: "Current grounded retrieval path reported by the API health contract.",
      agentRuntimeEngine: "Agent runtime engine",
      agentRuntimeEngineHint: "Current agent-execution orchestration boundary reported by the API health contract.",
      chatProvider: "Chat provider",
      chatProviderHint: "The active provider that grounded chat and agent runtime bindings resolve into by default.",
      chatModel: "Chat model",
      chatModelHint: "The default model name currently exposed by the API health contract.",
      optionalRuntimes: "Optional runtimes",
      optionalRuntimesHint: "Tracks whether the current API environment can actually load the pilot technology paths.",
      runtimeReady: "Ready",
    ...
    posture: {
      ...
      sensitiveEventsHint: "Recent revocations, suspensions, and membership removals visible to the current member."
    },
    governance: {
      ...
      deleteBlockedInUse: "This governed runtime resource is still in use. Remove the active bindings before deleting it.",
      ...
      posture: {
        ...
        disabledBoundModelsHint: "Model endpoints that are disabled but still attached to agent definitions.",
        disabledBoundTools: "Disabled bound tools",
        disabledBoundToolsHint: "Tool registrations that are disabled while still referenced by agent definitions.",
        approvalGatedTools: "Approval-gated tools",
        approvalGatedToolsHint: "Registered tools that still stay behind an explicit approval boundary.",
        unboundEnabledRuntime: "Unbound enabled runtime",
        unboundEnabledRuntimeHint: "Enabled models and tools that are available but not yet bound into agent delivery.",
        quickActions: "Governance follow-up",
        quickActionsDescription: "Move from runtime resource posture into the agent and admin surfaces that can resolve the next issue.",
    ...
    models: {
      title: "Model endpoints",
        description: "Register provider-facing endpoints and keep the product-ready model contract explicit.",
        governance: {
      ...
      previewHint: "Run a live preview to verify that this model endpoint can answer a minimal chat request.",
      previewEmpty: "Run validation to inspect the current provider response and runtime metadata.",
    ...
    tools: {
      ...
      description: "Track callable tools before future agent runtime and MCP expansion starts consuming them.",
      governance: {
      ...
      connectorReferenceHint: "Store the future MCP connector identifier or routing key for this reserved tool.",
      ...
      directUseHint: "This tool can be invoked directly once the runtime allows it.",
      governanceActions: {
        title: "Governance actions",
        description: "Apply direct runtime-governance actions without editing the full registration form.",
        ...
        connectorRequired: "Configure a connector reference before moving this reserved MCP tool into integration-ready state.",
        applyFailed: "Tool governance action failed."
      },
      preview: "Preview tool",
      previewing: "Previewing...",
      previewTitle: "Tool preview",
      previewEmpty: "Run a preview to inspect the current tool response and runtime trace.",
      ...
      previewRequestMeta: "Request metadata",
      previewResponseMeta: "Response metadata",
      previewScopeMissing: "A tenant scope is required before this tool can be previewed.",
      ...
      auditScopeMissing: "A tenant scope is required before runtime audit can be reviewed.",
      auditTenantReady: "Recent governed tool traces are available for this tenant scope.",
      auditEmpty: "No recent tool runtime traces match the current audit filter.",
      auditActions: {
      ...
      mcpWorklist: {
        ...
        ready: "{count} bound reserved tools with {traces} recent reserved traces are ready for boundary review.",
        scopeMissing: "A tenant scope is required before the MCP boundary queue can be reviewed.",
        ...
        noRecentTrace: "No recent reserved runtime trace has been recorded for this boundary yet.",
        empty: "No reserved MCP boundary tools need review in the current tenant scope.",
        statuses: {
          reviewing: "Reviewing",
      ...
      runtimePacket: {
        ...
        statusReview: "Review",
        healthyDetail: "This tool currently looks stable enough to stay in the governed runtime inventory.",
        disabledDetail: "Disabled traces are blocking active runtime usage and should move straight into affected-agent cleanup.",
        approvalDetail: "Approval-gated traces are active, so the approval boundary should be reviewed before broader rollout.",
        reservedDetail: "Reserved MCP traces still need connector-side runtime closure before this tool can move forward cleanly.",
        integrationPendingDetail: "This tool already points at a connector but still has pending MCP runtime follow-up to close.",
        failedDetail: "Recent failed traces suggest the runtime configuration should be reviewed before operators keep depending on this tool.",
    ...
    mcpConnectors: {
      ...
      description: "Manage connector assets before reserved MCP tools move into real runtime attachment.",
      new: "New connector",
      preview: "Preview connector",
      previewing: "Previewing connector...",
      previewTitle: "Connector runtime preview",
      previewEmpty: "Run a connector preview to inspect current reachability and transport metadata.",
      ...
      runtimePacket: {
        ...
        statusAttention: "Attention",
        statusReview: "Review",
        healthyDetail: "This connector is registered and can continue through the governed MCP delivery path.",
        configurationDetail: "This connector still needs basic runtime configuration before it can safely carry reserved MCP tools.",
        reservedDetail: "Reserved MCP agents still depend on this connector relationship being cleared through boundary governance.",
        pendingDetail: "Pending MCP agents are already waiting on this connector relationship to move into real runtime attachment.",
    ...
    retrievalProfiles: {
      ...
      description: "Define governed retrieval behavior that knowledge bases, grounded chat, and agent execution previews can resolve at runtime.",
      new: "New profile",
  ...
  home: {
    ...
    entry: {
      ...
      loginHint: "Use the sign-in entry to create a local session before opening protected surfaces."
    },
    hero: {
    ...
    status: {
      ...
      loaded: "Loaded {tenantCount} tenants, {workspaceCount} workspaces, and {knowledgeBaseCount} knowledge bases."
    },
    scope: {
      title: "Live scope selection",
      description: "Keep the home surface concise while reflecting the tenant, workspace, and knowledge base you are actively operating.",
      notAvailable: "Not available",
      ...
      liveScopeDescription: "This scope drives the platform counts, status signals, and operating context shown on the home surface."
    },
    metrics: {
      tenants: "Tenants",
    ...
    architecture: {
      ...
      govern: {
        title: "Govern",
        description: "{tenantCount} tenants and {workspaceCount} workspaces are currently under platform control.",
        value: "{count} knowledge scopes"
      },
      knowledge: {
        title: "Prepare knowledge",
        description: "{count} documents are registered in the active knowledge scope.",
        value: "{count} retrieval-ready"
      },
      ingest: {
        title: "Run ingestion",
        description: "{count} documents are currently in active processing lanes.",
        value: "{count} failed runs"
      },
      answer: {
        title: "Ground answers",
        description: "{count} persisted conversations are currently available in the active workspace.",
        value: "{count} messages stored"
      },
      extend: {
        title: "Extend with agents",
        description: "{count} tool-enabled agent definitions are available for runtime handoff.",
        value: "{count} active agents"
      }
    },
    commandCenter: {
      title: "Command packets",
      description: "Use the current tenant and knowledge scope to enter the next real operating lane instead of starting from scratch on every surface.",
      recovery: {
        title: "Recovery packet",
        metric: "Open recovery items",
        healthyDetail: "No failed workflows or failed documents are currently pressuring the active scope.",
        attentionDetail: "{workflowCount} failed workflows and {documentCount} failed documents currently need follow-up in the active scope.",
      ...
      retrieval: {
        ...
        readyDetail: "{count} documents are ready to support grounded answers in the active knowledge scope.",
        validatedDetail: "{count} retrieval-ready documents have already cleared live validation and can continue into grounded chat.",
        reviewDetail: "{count} retrieval-ready documents are available, but the latest validation pass still needs operator review before chat becomes the default lane.",
        blockedDetail: "The latest validation pass did not clear grounded chat. Review source evidence or ingestion state before reopening the answer lane.",
        pendingDetail: "No retrieval-ready documents are visible yet. Continue intake and indexing before depending on grounded answers.",
        unresolvedDetail: "Resolve a knowledge-base scope first so retrieval readiness stays tied to a real asset boundary.",
      ...
      agents: {
        ...
        readyDetail: "{name} is the clearest active runtime handoff for the current home scope.",
        pendingDetail: "{name} is active, but the leading handoff still needs cleaner scope alignment before launch.",
        emptyDetail: "No active agents are available in the current tenant scope yet.",
      ...
      governance: {
        ...
        attentionDetail: "{count} active agents still need runtime governance follow-up before clean delivery.",
        reviewDetail: "{count} registered tools still remain behind an approval boundary.",
        healthyDetail: "Runtime governance posture is stable for the current tenant scope.",
    ...
    capabilities: {
      ...
      description: "The home page stays focused. Each capability below opens the formal built surface instead of repeating administrative workflows.",
      openSurface: "Open Surface",
      chatDescription: "Grounded chat with persisted conversations and citation-aware responses.",
      documentsDescription: "Document ingestion, indexing state, and retrieval-ready asset review.",
      agentsDescription: "Agent design, tool access configuration, and execution control.",
      adminDescription: "Tenant governance, publication control, and platform administration."
    },
    platform: {
      title: "Platform status",
      description: "High-level signals only, sufficient to understand platform readiness without turning home into a full operations dashboard.",
      api: "API connection",
      apiHealthy: "The local API is reachable and the home surface is reading live platform data.",
      apiAttention: "The local API needs attention before the platform home can stay reliable.",
      scope: "Scope readiness",
      scopeHealthy: "A tenant and workspace are currently resolved for platform entry.",
      scopePending: "Select a tenant and workspace to activate the full home scope.",
      retrieval: "Retrieval surface",
      retrievalHealthy: "{count} indexed documents are visible in the active knowledge scope.",
      retrievalValidated: "{count} indexed documents are live-validated for grounded chat in the active knowledge scope.",
      retrievalReview: "Retrieval evidence is available, but the latest validation posture is still {status}.",
      retrievalBlocked: "The latest validation posture is blocking grounded chat until source evidence is reviewed.",
      retrievalPending: "No knowledge base is currently resolved for retrieval signals.",
      agents: "Agent lane",
      agentHealthy: "{count} active agents are available in the active tenant scope.",
      agentPending: "No active agents are configured in the current tenant scope yet.",
      workflows: "Workflow lane",
      workflowHealthy: "No failed workflow pressure is visible in the active tenant scope.",
    ...
    signals: {
      title: "Live signals",
      description: "A concise live readout from the current scope to keep the platform home connected to operational activity.",
      ...
      noConversationDetail: "Start a grounded chat thread to surface the first conversation signal.",
      ...
      noAgentRuns: "No agent launches have been recorded in the active tenant scope yet."
    },
    agentTelemetry: {
      title: "Agent runtime activity",
      description: "Follow the latest recorded agent launches from the current tenant scope without opening the full agent console.",
      openAgents: "Open agents",
      latestLaunch: "Latest launch {value}",
      noLatestLaunch: "No recorded launch yet.",
      recentRuns: "Recent launches",
      empty: "No agent runtime launches are visible in the current tenant scope yet.",
      unknownAgent: "Unknown agent definition",
      ...
      metricsDocumentsHint: "Launches that routed into the document operations surface."
    },
    agentExecutions: {
      title: "Execution task activity",
      description: "Keep recent agent execution results and bound tool traces visible from the current tenant home scope.",
      openOperations: "Open operations",
      ...
      metrics: {
        ...
        completed: "Completed tasks",
        completedHint: "Execution tasks that already produced a final runtime result.",
        failed: "Failed tasks"
      }
    },
    runtimeGovernance: {
      title: "Runtime governance",
      description: "Review scoped model and tool governance pressure from home before diving into admin or agent delivery surfaces.",
      openAttentionAgents: "Open attention agents",
      ...
      actionsDescription: "Use the built governance surfaces to resolve scope, model, and tool pressure without rebuilding context by hand.",
      metrics: {
        attentionAgents: "Attention agents",
        attentionAgentsHint: "Active agents in the current tenant scope that still need scope, retrieval, model, or tool cleanup.",
        disabledBoundModels: "Disabled bound models",
        disabledBoundModelsHint: "Model endpoints disabled while still connected to active agents.",
        disabledBoundTools: "Disabled bound tools",
        disabledBoundToolsHint: "Tool registrations disabled while still connected to active agents.",
        approvalGatedTools: "Approval-gated tools",
        approvalGatedToolsHint: "Registered tools that still remain behind an admin approval boundary."
      },
      signalValues: {
    ...
    activity: {
      ...
      description: "Stay close to the latest indexed or changed documents in the active knowledge scope.",
      openAllDocuments: "Open all documents",
      versionSummary: "Version {version} · {chunks} chunks",
      updatedAt: "Updated {value}",
      workflowState: "Workflow {value}",
      openDocument: "Open document",
      empty: "No recent documents are visible in the active knowledge scope yet."
    },
    workflowLane: {
      title: "Workflow queue snapshot",
      description: "Recent execution updates for the active tenant without leaving the home overview.",
      openOperations: "Open operations",
    ...
    agentLane: {
      title: "Active agents",
      description: "The currently enabled agent definitions that can be handed into built operator surfaces.",
      openAgents: "Open agents",
      noObjective: "No business objective has been recorded for this active agent yet.",
    ...
    retrievalInspector: {
      ...
      description: "Run a live hybrid retrieval check against the active knowledge base before validating grounded answers or escalation routes.",
      queryTitle: "Inspect retrieval results",
      queryDescription: "Submit a real question and review the exact chunks the current retrieval pipeline would surface.",
      queryLabel: "Query text",
      queryPlaceholder: "Ask about a policy, document section, workflow, or product fact",
      topKLabel: "Top K",
      run: "Run retrieval",
      ...
      compareStatusRunning: "Comparing live retrieval output across native and llamaindex_pilot...",
      statusLoaded: "Loaded {count} retrieval results.",
      compareStatusLoaded: "Comparison loaded with {shared} shared ranked chunks.",
      validationReady: "{count} retrieval hits are ready to support grounded validation in chat.",
      validationEmpty: "This validation query returned no evidence. Review the source lane before continuing.",
      statusEmpty: "No retrieval results matched this query in the active knowledge scope.",
      statusFailed: "Retrieval diagnostics failed.",
      scopeRequired: "Select a tenant, workspace, and knowledge base first so retrieval diagnostics stay attached to a real scope.",
      waiting: "Run a retrieval query to inspect ranked chunks, scoring signals, and the resulting document path.",
  ...
  admin: {
    ...
    filters: {
      tenantScope: "Select tenant scope",
      search: "Search tenants, workspaces, knowledge bases, or retrieval profiles",
    ...
    metrics: {
      ...
      publishedKnowledgeBasesHint: "Retrieval-ready published knowledge surfaces",
      activeAgents: "Active agents",
      activeAgentsHint: "Enabled agent definitions available to support governed operations",
    ...
    resourceActions: {
      ...
      description: "Create tenants, workspaces, and knowledge bases from the admin surface without leaving governance scope."
    },
    sections: {
    ...
    overviewLanes: {
      ...
      description: "Use the overview surface to branch into the specific governance lane that matches the current operational question.",
      openLane: "Open lane",
      directory: {
        title: "Directory lane",
        description: "{workspaceCount} workspaces and {knowledgeBaseCount} knowledge bases are visible in the current governance scope.",
        value: "{agentCount} governed agents"
      },
      access: {
        title: "Access lane",
        description: "{memberCount} persisted members are currently visible inside the selected admin scope.",
        value: "{invitedCount} invitations pending"
      },
      security: {
        title: "Security lane",
        description: "{eventCount} recent access events are currently visible for governance review.",
    ...
    accessSummary: {
      ...
      totalMembersHint: "Persisted members visible in the current governance scope.",
      invitedMemberships: "Invited memberships",
      invitedMembershipsHint: "Tenant invitations that still need member activation.",
    ...
    securitySummary: {
      ...
      description: "Review dormant accounts, invitation timing, and sensitive governance activity without leaving the admin scope.",
      activeAccounts: "Active accounts",
      activeAccountsHint: "Persisted directory accounts currently able to authenticate.",
    ...
    securityWatch: {
      ...
      description: "Prioritize invitation and account conditions that may block onboarding or require governance follow-up.",
      expiredInvitations: "Expired invitations",
      expiredInvitationsDetail: "{count} invited memberships already passed their activation window.",
      expiredInvitationsHealthy: "No invited memberships are already past their activation window.",
      expiringInvitations: "Expiring invitations",
      expiringInvitationsDetail: "{count} invited memberships will expire within the next 72 hours.",
      expiringInvitationsHealthy: "No invitations are about to expire in the next 72 hours.",
      dormantAccounts: "Dormant accounts",
    ...
    currentActorSecurity: {
      ...
      description: "Keep the signed-in administrator or reviewer visible inside the same security lane so session health and governed access stay connected.",
      ...
      notAvailable: "The current signed-in actor could not be resolved from the visible directory scope."
    },
    directory: {
      title: "Tenant and workspace directory",
      description: "Ownership scope, workspace lifecycle, and knowledge footprint.",
    ...
    governance: {
      ...
      description: "Publication state and tenant alignment for visible knowledge assets.",
      knowledgeBase: "Knowledge Base",
      workspace: "Workspace",
      ...
      published: "Published",
      draft: "Draft",
      noKnowledgeBases: "No knowledge bases match the current scope and search filters."
    },
    agents: {
      title: "Agent governance",
      description: "Review persisted agent definitions alongside tenant governance and route them into the right operational surface.",
      agent: "Agent",
      tenant: "Tenant",
      mode: "Mode",
      status: "Status",
    ...
    members: {
      ...
      description: "View member coverage across tenants and manage the active tenant membership boundary from admin scope.",
      member: "Member",
      memberships: "Memberships",
      account: "Account",
      actionsColumn: "Actions",
      ...
      noMembers: "No members match the current governance scope and search filters.",
    ...
    audit: {
      ...
      description: "Latest member sign-in and invitation governance activity in the selected admin scope.",
      openMember: "Open member",
      filter: "Event type",
    ...
    scopePanel: {
      ...
      description: "Current admin filter is backed by the live tenant directory.",
      tenantScope: "Tenant scope",
      allTenants: "All tenants",
      unknownTenant: "Unknown tenant",
      visibleInventory: "Visible inventory",
      inventoryCounts: "{workspaceCount} workspaces · {knowledgeBaseCount} knowledge bases",
      ...
      defaultFallbackRetrievalProfile: "Platform default fallback",
      disabledAssignedRetrievalProfile: "Disabled profile assignments",
      retrievalProfileAllDescription: "Knowledge-base governance is not currently narrowed by retrieval posture.",
      retrievalProfileFilteredDescription: "Knowledge-base governance is currently narrowed to one effective retrieval posture.",
      publishedKnowledgeBases: "Published knowledge bases",
    ...
    chatScope: {
      ...
      description: "Tenant-scoped persisted chat activity across the selected governance tenant scope.",
    ...
    agentRuntime: {
      ...
      description: "Track recorded agent launches across the current governance scope so runtime usage stays visible to the admin console.",
      openAgents: "Open agents",
      latestLaunch: "Latest launch {value}",
      noLatestLaunch: "No recorded launch yet.",
      tenantBreakdown: "Tenant runtime breakdown",
      tenantRunCount: "{count} launches",
      noTenantRuns: "No tenant runtime activity is visible in the current governance scope.",
      recentRuns: "Recent recorded launches",
      empty: "No recorded agent launches are visible in the current governance scope yet.",
      unknownAgent: "Unknown agent definition",
      metrics: {
        totalHint: "Combined recorded launches across the selected governance scope.",
    ...
    agentExecutions: {
      ...
      description: "Bring cross-tenant agent execution results and bound tool traces into the admin overview before jumping into agents or operations.",
      openOperations: "Open operations",
      openAgents: "Open agents",
      openExecutionRoute: "Open execution route",
      ...
      latestExecution: "Latest execution {value}",
      noLatestExecution: "No execution has been recorded yet.",
      noTenantExecutions: "No execution activity is visible in the current governance scope.",
      recentExecutions: "Recent execution traces",
      empty: "No agent executions are visible in the current governance scope yet.",
      metrics: {
        total: "Execution tasks",
        totalHint: "Combined execution tasks across the selected governance scope.",
        completed: "Completed tasks",
        completedHint: "Execution tasks that already produced a final result payload.",
        failed: "Failed tasks"
      }
    },
    workflowRuntime: {
      title: "Execution pressure observability",
      description: "Aggregate cross-tenant workflow pressure from the governance view and jump directly into failed recovery, queue supervision, or workflow follow-up.",
      openOperations: "Open operations",
    ...
    documentRuntime: {
      ...
      description: "Aggregate cross-tenant document intake, failure, and completion posture from governance and jump directly into failed documents, document surfaces, or operations.",
      openDocuments: "Open documents",
      openOperations: "Open operations",
      ...
      noTenantPressure: "No document intake pressure is visible in the current governance scope.",
      metrics: {
        failed: "Failed documents",
        failedHint: "Failed documents that still need recovery handling in the current governance scope.",
        active: "Documents in intake",
        activeHint: "Documents still being parsed, chunked, or indexed.",
        completed: "Completed documents",
        completedHint: "Documents already completed and ready for downstream retrieval use.",
        total: "Total documents",
        totalHint: "All documents currently registered in the governance scope."
      }
    },
    runtimeGovernance: {
      ...
      metrics: {
        attentionAgents: "Attention agents",
        attentionAgentsHint: "Active agents with scope, retrieval, model, or tool governance issues in the current admin scope.",
        disabledBoundModels: "Disabled bound models",
        disabledBoundModelsHint: "Model endpoints disabled while still connected to agent definitions.",
        disabledBoundTools: "Disabled bound tools",
        disabledBoundToolsHint: "Tool registrations disabled while still connected to agent definitions.",
        approvalGatedTools: "Approval-gated tools",
        approvalGatedToolsHint: "Registered tools that still require explicit admin approval.",
    ...
    retrievalProfiles: {
      ...
      description: "Review each retrieval posture as a governed asset, including where it is assigned and where platform-default fallback is still carrying scope.",
      ...
      status: {
        disabledAssigned: "This retrieval profile is disabled while still assigned to {count} knowledge bases.",
        defaultFallback: "This profile is currently serving as the default fallback for {count} knowledge bases.",
        unused: "This retrieval profile is configured but not yet bound inside the current admin scope.",
        healthyAssigned: "This retrieval profile is actively assigned to {count} knowledge bases in the current admin scope."
      }
    },
    tenantChat: {
      title: "Tenant chat activity",
      description: "Rank tenants by persisted chat activity so governance can spot real operator usage.",
    ...
    chatSignals: {
      title: "Chat signals",
      description: "Simple governance signals derived from the current tenant chat activity snapshot.",
      mostActiveTenant: "Most active tenant",
      noTenantActivity: "No tenant activity",
      activeTenantDetail: "{messageCount} messages across {conversationCount} conversations",
      noPersistedMessages: "No persisted messages are visible in this scope yet.",
      openTenantChat: "Open tenant chat",
      staleChatTenants: "Stale chat tenants",
      staleChatDetail: "No recent chat activity in the last 7 days, or no recorded activity yet.",
      reviewChatScope: "Review chat scope",
      idleConversationScope: "Idle conversation scope",
      idleConversationDetail: "Tenants with conversation records but no currently active threads.",
      inspectIdleScope: "Inspect idle scope"
    },
    watchlist: {
      title: "Governance watchlist",
      description: "Items that deserve operator attention in the current scope.",
      attention: "attention",
      review: "review",
      healthy: "healthy",
      workspaceLifecycleReview: "Workspace lifecycle review",
      workspaceLifecycleReviewDetail: "{count} archived workspaces should be reviewed against retention policy.",
      ...
      documentRecoveryPressureDetail: "{count} failed documents across {tenantCount} tenants still need intake recovery follow-up.",
      documentIntakePressureDetail: "{count} documents across {tenantCount} tenants are still moving through intake and should remain under supervision.",
      documentRecoveryHealthy: "No document intake or recovery pressure is visible in the current governance scope.",
      reviewDocumentPressure: "Review document pressure",
      knowledgePublicationGate: "Knowledge publication gate",
      knowledgePublicationDetail: "{count} knowledge bases remain in draft state.",
      ...
      publishedRetrievalDetail: "{count} published knowledge bases are available to operators.",
      publishedRetrievalEmpty: "No published knowledge bases are visible in this scope.",
      viewPublished: "View published",
      retrievalGovernancePressure: "Retrieval governance pressure",
      retrievalGovernanceDisabledDetail: "{count} knowledge bases are still assigned to disabled retrieval profiles.",
      retrievalGovernanceDefaultFallbackDetail: "{count} knowledge bases still rely on the platform default retrieval profile.",
      retrievalGovernanceHealthy: "Retrieval-profile assignment looks stable in the current scope.",
      reviewRetrievalGovernance: "Review retrieval governance",
      runtimeGovernancePressure: "Runtime governance pressure",
      runtimeGovernancePressureDetail: "{count} active agent bindings currently point at disabled runtime resources.",
      runtimeGovernanceMissingRetrievalDetail: "{count} active agent scopes currently resolve without a valid governed retrieval profile.",
      runtimeGovernanceApprovalDetail: "{count} registered tools still sit behind an approval boundary.",
      runtimeGovernanceHealthy: "Runtime governance bindings look stable in the current scope.",
      reviewRuntimeGovernance: "Review runtime governance",
      agentGovernanceGate: "Agent governance gate",
      agentGovernanceDetail: "{count} active agents are missing a scoped knowledge boundary.",
      agentDraftDetail: "{count} agent drafts are still pending governance review.",
      agentGovernanceHealthy: "Visible agents have scope coverage or remain intentionally paused.",
      reviewAgents: "Review agents",
      memberActivationQueue: "Member activation queue",
      memberActivationQueueDetail: "{count} invited tenant memberships still need activation.",
      memberActivationQueueHealthy: "No invited memberships are waiting for activation.",
      reviewInvitations: "Review invitations"
    },
    executionPackets: {
      title: "Execution packets",
      description: "Bundle the next governance action into recovery, publication, runtime, and access packets without rebuilding scope by hand.",
      scopePendingValue: "Scope mapping pending",
      recovery: {
        title: "Recovery packet",
        metric: "Primary recovery scope",
        readyDetail: "Failed-document and failed-workflow recovery can launch directly from {workspace} and {knowledgeBase}.",
        pendingDetail: "Select or resolve a primary workspace and knowledge base before routing failed queues into runtime recovery lanes.",
      ...
      publication: {
        ...
        draftDetail: "{count} knowledge bases are still in draft and should be reviewed before wider operator use.",
        healthyDetail: "Visible knowledge bases are already published for governed retrieval use.",
      ...
      runtime: {
        ...
        readyDetail: "{count} active agents already have scope-ready runtime handoff routes out of {total} active definitions.",
        pendingDetail: "{total} active agents are visible, but their scope resolution still needs governance review before clean runtime handoff.",
        emptyDetail: "No active agents are currently visible for runtime handoff in this governance scope.",
      ...
      recoveryRuntime: {
        ...
        readyDetail: "{count} recovery agents already have scope-ready routes out of {total} visible recovery definitions.",
        pendingDetail: "{total} recovery agents are visible, but their scope resolution still needs governance cleanup before clean runtime recovery.",
        emptyDetail: "No recovery agents are currently visible for runtime recovery in this governance scope.",
      ...
      access: {
        ...
        pendingDetail: "{count} invited memberships still need activation before those members can fully enter governed routes.",
        healthyDetail: "No invited memberships are waiting for activation in the current governance scope.",
    ...
    runtimeRoutes: {
      ...
      description: "Move directly from governance review into the built execution surfaces for active agents.",
      scopeReady: "Scope ready",
      scopePending: "Scope pending",
      retrievalMissing: "Retrieval review",
      retrievalDisabled: "Retrieval blocked",
      noObjective: "No business objective is attached to this active agent yet.",
      ...
      retrievalMissingDetail: "This runtime route still needs a valid governed retrieval profile before it should launch.",
      retrievalDisabledDetail: "{profile} is disabled and should be remediated before this runtime route launches.",
      ...
      empty: "No active agents are available for runtime handoff in the current governance scope."
    },
    runtimeTaskPacket: {
      title: "Runtime task packet",
      description: "Promote the next active agent handoff into one governed packet before opening execution surfaces.",
      emptyTitle: "No active runtime task",
      emptyDetail: "No active agent is currently ready to be promoted from governance into runtime execution.",
      readyDetail: "This handoff can move directly into {surface} with the current tenant and knowledge context.",
      scopeReviewDetail: "Review the runtime scope before sending this handoff into {surface}.",
      retrievalMissingDetail: "Review retrieval governance before sending this handoff into {surface}.",
      retrievalDisabledDetail: "{profile} is currently disabled and should be remediated before this handoff is launched.",
      primaryAction: "Open runtime route",
  ...
  auth: {
    ...
    hero: {
      ...
      documentOpsDescription: "Upload, reindex, inspect versions, and follow document activity from one surface.",
      workflowTitle: "Durable workflows",
        workflowDescription: "Track ingestion execution, retries, and failure recovery through stable operational lanes.",
        directoryTitle: "Directory-backed access",
        directoryDescription: "Session posture, tenant memberships, and invitation activation now resolve from persisted records.",
    ...
    assessment: {
      ...
      bootstrapAvailable: "The directory is still empty. This sign-in can become the initial platform administrator.",
      ready: "This member already has directory-backed access and can continue into the protected console.",
      invited: "This member still depends on invitation activation before protected routes can open.",
      inactiveAccount: "This member account is inactive and needs administrator action before sign-in.",
      inactiveMembership: "This member exists, but no active tenant membership is available yet.",
    ...
    errors: {
      ...
      inactiveMembership: "This member does not currently have an active tenant membership. Ask an administrator to activate a tenant assignment before signing in.",
      sessionInactiveAccount: "Your previous session was closed because the directory account is now inactive.",
      sessionInactiveMembership: "Your previous session was closed because no active tenant membership is currently available.",
      sessionRevoked: "Your previous session was revoked. Sign in again after the access change is resolved.",
      sessionMissingDirectoryUser: "Your previous session could not be restored from the persisted member directory."
    },
    guard: {
  ...
  workspace: {
    ...
    runtimeTaskPacket: {
      ...
      secondaryGovernance: "Open governance",
      pending: "Pending",
      noPrompt: "No launch prompt is currently attached to this workspace handoff.",
      default: {
        ...
        details: {
          intake: "Upload the first source document into the active knowledge base before grounded validation begins.",
          monitoring: "{count} in-flight ingestion or workflow items still need operator monitoring before the loop can close.",
          recovery: "{count} failed document or workflow items need recovery before the active scope is considered healthy.",
          validation: "{count} retrieval-ready documents are available. Continue in chat to validate grounded answers with citations.",
          validationReady: "{count} retrieval-ready documents are validated against live evidence. Continue in chat and confirm the cited answer stays stable.",
          validationReview: "{count} retrieval-ready documents are available, but the latest validation pass still needs operator review before broad rollout.",
          validationBlocked: "The latest validation pass did not clear grounded chat. Review the source evidence or ingestion chain before asking more cited questions."
        },
        objectives: {
          intake: "Land the first document in the active knowledge base and establish retrieval-ready assets.",
          monitoring: "Keep the active ingestion lane visible until queued and running work settles.",
          recovery: "Resolve failed document or workflow states before broadening downstream usage.",
          validation: "Use grounded chat to confirm the active knowledge base now answers with citations.",
          validationReady: "Use grounded chat to confirm the validated knowledge base still answers with stable citations.",
          validationReview: "Review the latest validation pass, then decide whether the active scope is ready for wider grounded use.",
          validationBlocked: "Recover source evidence quality before reopening grounded validation in chat."
        }
      },
      statuses: {
        attention: "Attention",
      ...
      details: {
        general: "Continue the current operator path from {source} while keeping scope and runtime context aligned.",
        agent_brief: "Use the incoming agent brief and current scope to continue operator execution without rebuilding context.",
        grounded_validation: "Validate downstream retrieval quality in grounded chat before closing the execution loop.",
        document_recovery: "Inspect source document state, indexing health, and workflow lineage together before reissuing work.",
        workflow_recovery: "Keep the selected run, retry posture, and execution context aligned until recovery is settled."
      },
      objectives: {
        general: "Continue the current workspace task inside the active scope.",
        agent_brief: "Use the current agent brief to continue scoped execution.",
        grounded_validation: "Confirm that completed execution produced retrieval-ready knowledge behavior.",
        document_recovery: "Resolve source-level issues before the next indexing or retry attempt.",
        workflow_recovery: "Stabilize the failed or active workflow before broadening execution."
      },
      fields: {
    ...
    runtimeRunbook: {
      ...
      description: "Use the incoming handoff intent to keep the next actions on a consistent platform path.",
      metrics: {
        target: "Target surface",
        scope: "Scope",
        subject: "Current subject",
      ...
      mainFlow: {
        ...
        validateReadyDetail: "Retrieval-ready knowledge is available. Use chat to confirm answers, citations, and operator confidence before closing the loop.",
        validatePendingDetail: "Grounded validation should wait until at least one document completes ingestion and indexing.",
        validateReviewDetail: "The latest validation pass found evidence, but the scope still needs operator review before this becomes the default grounded lane.",
        validateBlockedDetail: "The latest validation pass did not support grounded chat. Inspect source evidence and execution health before reopening answer validation.",
        reviewReadySources: "Review ready sources"
      },
      agentBrief: {
        alignSurfaceTitle: "Align the runtime surface",
        alignSurfaceDetail: "Move into the most appropriate built surface before the operator starts making manual decisions.",
        checkScopeTitle: "Check the scoped assets",
        checkScopeDetail: "Inspect the current document lane so the active workspace scope stays grounded in visible source state.",
        closeLoopTitle: "Keep the definition linked",
        closeLoopDetail: "Return to the agent or governance surface before broadening rollout or changing the execution posture."
      },
      groundedValidation: {
        validateAnswerTitle: "Validate the grounded answer lane",
        validateAnswerDetail: "Use chat to confirm that the completed execution produces retrieval-ready answers and citations.",
        validateAnswerReviewDetail: "The latest validation pass returned evidence, but the result still needs review before this answer lane is treated as stable.",
        validateAnswerBlockedDetail: "Grounded validation is blocked by the latest evidence check. Reopen document review before continuing cited answers.",
        validateAnswerPendingDetail: "No completed retrieval validation is attached yet. Run or resume validation before relying on grounded answers.",
        inspectSourcesTitle: "Inspect the supporting sources",
        inspectSourcesDetail: "Open the document surface to confirm the source assets, versions, and retrieval context behind the answer.",
        inspectSourcesBlockedDetail: "Inspect the source assets and latest ingestion output first so the failed validation signal can be traced back to concrete evidence state.",
        closeLoopTitle: "Close the operator loop",
        closeLoopDetail: "Bring the validated outcome back to governance so the downstream behavior is formally reviewed.",
        closeLoopPendingDetail: "Keep this validation loop on chat or documents until the evidence posture is ready for formal governance review."
      },
      documentRecovery: {
        inspectDocumentTitle: "Inspect the failed document lane",
        inspectDocumentDetail: "Review the selected document, indexing state, and source readiness before reissuing work.",
        reviewLineageTitle: "Review workflow lineage",
        reviewLineageDetail: "Follow the workflow surface to understand retries, blocking steps, and execution posture around this document.",
        briefAgentTitle: "Prepare the next operator brief",
        briefAgentDetail: "Use chat or the current agent definition to summarize recovery posture before further intervention."
      },
      workflowRecovery: {
        stabilizeTitle: "Stabilize the workflow lane",
        stabilizeDetail: "Keep the selected run under workflow supervision until the blocking state and retry posture are explicit.",
        inspectDocumentTitle: "Inspect the affected source",
        inspectDocumentDetail: "Open the document lane to compare the failed run with the underlying source object and knowledge scope.",
        closeLoopTitle: "Close the governance loop",
        closeLoopDetail: "Return the recovery path to governance once the current owner, scope, and access posture are clear."
      }
    },
    status: {
      ...
      workspaceCreated: "Workspace {name} created. Create a knowledge base to start using it.",
      ...
      knowledgeBasePublicationUpdateFailed: "Knowledge base publication update failed.",
      ...
      groundedAnswerReadyWithAgent: "Grounded answer ready through agent {name}.",
      ...
      sourceChunkOpenedInDocuments: "Source chunk {index} opened in document operations.",
      sourceDocumentOpenedInDocuments: "Source document opened in document operations.",
      ...
      recommendationPrompts: {
        documentReady: "Use {title} as the primary source and explain the retrieval-ready facts with citations.",
        workflowCompleted: "Summarize the completed execution for {label} and explain what became ready downstream.",
        workflowInProgress: "Review the in-progress execution for {label} and tell me what should be checked next.",
      ...
      documentActionPartial: "{successCount} documents {actionResult}. {failureCount} failed.",
      documentDeleteCompleted: "{count} documents deleted from the active knowledge base.",
      documentRestoreCompleted: "{count} documents restored to the active knowledge base.",
      ...
      feedbackValidationPrepared: "Feedback candidate loaded into retrieval validation.",
      feedbackComparisonPrepared: "Feedback candidate loaded into retrieval comparison."
    },
    retrievalInspector: {
      title: "Retrieval diagnostics",
      ...
      queryLabel: "Query",
      queryPlaceholder: "Ask a retrieval-focused question for the active scope...",
      topKLabel: "Top K",
      run: "Run diagnostics",
      compare: "Compare engines",
      comparing: "Comparing...",
      ...
      statusRunning: "Retrieval diagnostics are running against the active knowledge base.",
      compareStatusRunning: "Comparing live retrieval output across native and llamaindex_pilot.",
      statusLoaded: "{count} retrieval results loaded for review.",
      compareStatusLoaded: "Comparison loaded with {shared} shared ranked chunks.",
      statusEmpty: "No retrieval results matched the current query.",
      statusFailed: "Retrieval diagnostics failed.",
      scopeRequired: "Select a tenant, workspace, and knowledge base before running retrieval diagnostics.",
      waiting: "Run a retrieval diagnostic query to inspect live matching chunks.",
    ...
    agentRecommendations: {
      "document-ready-for-grounded-chat": "This document is retrieval-ready, so a grounded chat agent is the best next operator path.",
      "document-needs-intake": "This document still needs ingestion follow-up, so an intake-oriented agent is the strongest fit.",
      "document-needs-recovery": "This document is in a failed state, so a recovery-oriented agent should take over next.",
      "workflow-completed": "This workflow already completed, so the next best handoff is a grounded chat agent.",
      "workflow-in-progress": "This workflow is still moving, so an intake-oriented agent is best positioned to continue execution follow-up.",
      "workflow-failed": "This workflow failed, so a recovery-oriented agent is the clearest next owner."
    },
    ...
    errors: {
      ...
      selectedWorkspaceNoKnowledgeBases: "Selected workspace has no knowledge bases yet.",
      tenantNameSlugRequired: "Tenant name and slug are required.",
      workspaceNameSlugRequired: "Workspace name and slug are required.",
      knowledgeBaseNameSlugRequired: "Knowledge base name and slug are required.",
    ...
    headerBar: {
      ...
      cancel: "Cancel",
      runtimePacket: "Runtime packet",
      runtimeAligned: "The current workspace surface matches the attached agent mode.",
      ...
      objective: "Objective:",
      objectiveMissing: "No explicit objective is attached to the active runtime.",
    ...
    sharedAgentContext: {
      ...
      connectedCapabilities: "{count} connected capabilities",
      objective: "Objective:",
      objectiveMissing: "No explicit objective is attached to this agent context.",
      openDefinition: "Open Definition"
    },
    chatView: {
      ...
      agentObjectiveMissing: "No explicit agent objective is attached to the current chat runtime.",
      ...
      selectDocumentToInspect: "Select a document to inspect its metadata and chunks.",
      selectWorkflowToInspect: "Select a workflow run to inspect execution details.",
      workflowStepsAppear: "Step records will appear here once the workflow runs.",
    ...
    documentsView: {
      ...
      uploadFollowUpReady: "This document is ready for validation. Continue in grounded chat and confirm the cited answer is stable.",
      uploadFollowUpFailed: "This document hit a blocked execution path. Inspect the workflow run before continuing recovery work.",
      uploadFollowUpMonitoring: "This document is still moving through execution. Keep workflow supervision open until the state settles.",
      ...
      selectDocumentToInspect: "Select a document from the registry to inspect it.",
      selectDocumentOrWorkflow: "Select a document or workflow run to inspect processing details.",
      retryHelp:
    ...
    workflowsView: {
      ...
      running: "Running",
      runningDescription: "Runs that already started execution and are still in progress.",
      retryRuns: "Retry runs",
      retryRunsDescription: "Runs created from earlier failed execution attempts.",
      completed: "Completed",
      ...
      failureLaneDescription: "Runs that still need human intervention in the current tenant scope.",
      retryLane: "Retry lane",
      retryLaneDescription: "Retry volume already issued from earlier failed execution attempts.",
      pressureLane: "Queue pressure",
      pressureLaneDescription: "Combined queued and running work that is still in motion.",
      supervision: "Workflow supervision",
      supervisionTitle: "Route the current scope into the right execution queue.",
    ...
    sidebar: {
      ...
      modal: {
        ...
        saving: "Saving...",
        creating: "Creating...",
        tenantEditDescription: "Update the tenant profile without losing your place in the operator drawer.",
        ...
        tenantCreateDescription: "Create a new tenant scope in a focused modal instead of expanding the drawer layout.",
        tenantCreateTitle: "Create Tenant",
        createTenant: "Create Tenant",
        workspaceEditDescription: "Edit the workspace profile in a modal so the drawer stays readable.",
        workspaceEditTitle: "Edit Workspace",
        workspaceName: "Workspace name",
        workspaceSlug: "Workspace slug",
        workspaceSlugHint: "Used in workspace URLs and admin deep links.",
        workspaceDescription: "Workspace description",
        workspaceDescriptionHint: "Shown across operator and governance surfaces.",
        ...
        workspaceCreateDescription: "Create a new workspace in a dedicated modal instead of expanding the surrounding controls.",
        workspaceCreateTitle: "Create Workspace",
        createWorkspace: "Create Workspace",
        knowledgeBaseEditDescription: "Edit the knowledge base without pushing the rest of the drawer content out of view.",
        knowledgeBaseEditTitle: "Edit Knowledge Base",
        knowledgeBaseName: "Knowledge base name",
        knowledgeBaseSlug: "Knowledge base slug",
        knowledgeBaseSlugHint: "Used in retrieval scope URLs and citations review flows.",
        knowledgeBaseDescription: "Knowledge base description",
        knowledgeBaseDescriptionHint: "Shown in operator scope summaries and governance listings.",
        knowledgeBaseRetrievalProfile: "Retrieval profile",
        knowledgeBaseRetrievalProfileHint: "Bind this knowledge base to a governed retrieval profile for chat, diagnostics, and agent execution.",
        ...
        knowledgeBaseCreateDescription: "Create a new knowledge base in a focused modal flow.",
    ...
    registry: {
      ...
      description: "Search, filter, and inspect document processing state for the active knowledge base.",
    ...
    selectedDocument: {
      ...
      recommendedAgentsDescription: "Switch directly into a better-matched agent context for the current document state.",
      ...
      chunksAppearAfterIngestion: "Chunks will appear here after ingestion completes.",
      packet: {
        deletedState: "This document is currently removed from active retrieval scope.",
        deletedDescription: "Restore this document before sending it back into grounded chat or workflow validation.",
        failedState: "Recovery work is required before this document can return to healthy retrieval.",
        failedDescription: "Route the selected document into failure handling so retries, supervision, and source cleanup stay in one operator path.",
        readyState: "This document is retrieval-ready for grounded answers.",
        readyDescription: "The document has completed ingestion and indexing and can now hand off into chat or downstream validation.",
        intakeState: "This document is still moving through intake and indexing.",
        intakeDescription: "Keep the current document inside the intake lane until parsing, indexing, and workflow follow-up settle."
      }
    },
    documentActionSummary: {
      summarySuffix: "summary",
      successLine: "{successCount} of {requestedCount} documents {actionResult}.",
      failureLine: "{failureCount} documents failed and remain selected for follow-up.",
      allSucceeded: "All requested document actions completed successfully.",
      followUpRequired: "Follow-up Required",
      hiddenFailures: "{count} more failed documents remain selected for review.",
    ...
    selectedWorkflow: {
      ...
      recommendedAgents: "Recommended Agents",
      recommendedAgentsDescription: "Route this execution run into the agent that best matches the current workflow state.",
      switchAgent: "Switch Agent",
      activateInChat: "Activate in Chat",
      activateInDocuments: "Activate in Documents",
      activateInWorkflows: "Activate in Workflows",
      ...
      packet: {
        ...
        failedState: "This run needs intervention before recovery can continue.",
        failedDescription: "Keep the failed run in the recovery lane until the blocking issue is cleared and the next retry path is chosen.",
    ...
    workflowTimeline: {
      ...
      description: "Inspect recent automation runs, filter by execution type and status, and trace retries through history.",
